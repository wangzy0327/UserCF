...
public class MR2 {
    //输入文件路径
    //private static String inPath = "/user/wzy/UserCF/step1_output/part-r-00000";
    private static String inPath = "UserCF/step1_output/part-r-00000";
    //输出文件路径
    //private static String outPath = "/user/wzy/UserCF/step2_output";
    private static String outPath = "UserCF/step2_output";
    //设置缓存路径
    //这样让路径直接找输出矩阵所在的文件，它的别名才起作用
    //private static String cache = "/user/wzy/UserCF/step1_output/part-r-00000";
